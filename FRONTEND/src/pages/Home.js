        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Advancing space life sciences through comprehensive analysis and visualization 
              of NASA Space Biology publications
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Research Discovery</h3>
              <p className="text-gray-400">
                Explore thousands of NASA Space Biology publications with intelligent search 
                and filtering capabilities to find exactly what you need.
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-400">
                Interactive charts and graphs that reveal trends, patterns, and insights 
                in space biology research over time.
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-400">
                Get instant answers to your questions about space biology research 
                with our intelligent chatbot assistant.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-bold text-white mb-6">Advanced Search & Discovery</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300">Search by title, author, category, and keywords</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-cosmos-cyan rounded-full flex items-center justify-center mr-4 mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-300">Interactive timeline visualization</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-cosmos-cyan rounded-full flex items-center justify-center mr-4 mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-300">Trend analysis and publication patterns</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-cosmos-cyan rounded-full flex items-center justify-center mr-4 mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-300">Direct links to NASA resources</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-8">
              <div className="text-center">
                ...
                <h4 className="text-2xl font-bold text-white mb-4">Data-Driven Insights</h4>
                <p className="text-gray-400">
                  Our dashboard transforms complex research data into clear, actionable insights 
                  that advance the field of space biology.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-cosmos-gradient">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90 mb-8">
            Join researchers, students, and space enthusiasts in discovering the latest 
            NASA Space Biology publications and insights.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/find-your-interest" 
