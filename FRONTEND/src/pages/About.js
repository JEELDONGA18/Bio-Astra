...
const About = () => {
  const teamMembers = [
    {
      ...
      image: "👩‍💻",
      expertise: ["Machine Learning", "Data Analysis", "Space Biology", "Project Management"]
    },
    {
      name: "Alex Rodriguez",
      ...
      image: "👨‍💻",
      expertise: ["React.js", "UI/UX Design", "Data Visualization", "Web Development"]
    },
    {
      ...
      image: "👩‍🔬",
      expertise: ["Backend Development", "Cloud Computing", "Database Design", "API Development"]
    },
    {
      name: "James Wilson",
      role: "Data Engineer",
      ...
      image: "👨‍🔧",
      expertise: ["Data Engineering", "ETL Pipelines", "Database Integration", "Automation"]
    },
    {
      ...
      image: "👩‍🚀",
      expertise: ["Space Biology", "Research Methodology", "Scientific Communication", "NASA Programs"]
    }
  ];
  ...
  const mentor = {
    ...
    image: "👨‍🚀",
    expertise: ["NASA Research", "Space Biology", "Mentorship", "Program Leadership"],
  ...
  const projectTimeline = [
    {
      ...
      duration: "Months 1-2",
      description: "Conducted comprehensive analysis of NASA Space Biology publications and user requirements",
      status: "completed"
    },
    {
      phase: "Phase 2",
      ...
      duration: "Months 3-4",
      description: "Developed data pipelines and processed NASA publication datasets",
      status: "completed"
    },
    {
      phase: "Phase 3",
      ...
      duration: "Months 5-6",
      description: "Built the React.js dashboard with search, visualization, and AI integration features",
      status: "completed"
    },
    {
      phase: "Phase 4",
      ...
      duration: "Months 7-8",
      description: "Comprehensive testing, user feedback integration, and performance optimization",
      status: "in-progress"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Meet the team behind the Bio-Astra Dashboard and learn about our mission 
            to advance NASA Space Biology research through innovative technology.
          </p>
        </div>
        ...
        <div className="card mb-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              To create an innovative, user-friendly platform that democratizes access to NASA Space Biology 
              research, enabling scientists, students, and space enthusiasts worldwide to discover, analyze, 
              and contribute to our understanding of life in space. We believe that open access to research 
              data and intelligent tools can accelerate scientific discovery and inspire the next generation 
              of space biologists.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-8">
              {projectTimeline.map((phase, index) => (
                <div key={index} className="relative flex items-start">
                  <div className={`absolute left-3 w-3 h-3 rounded-full border-4 border-gray-900 ${
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Research Acceleration</h3>
                <p className="text-gray-300 text-sm">
                  Streamlining literature review and data discovery for space biology researchers
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-cosmos-gradient rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Education & Outreach</h3>
                <p className="text-gray-300 text-sm">
                  Making NASA research accessible to students and the general public
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-cosmos-gradient rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-300 text-sm">
                  Fostering connections between researchers and institutions worldwide
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Have questions about the Bio-Astra Dashboard? We'd love to hear from you 
            and learn how we can improve the platform for the space biology community.
          </p>
