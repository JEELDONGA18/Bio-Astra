...
export default function AnatomyViewer() {
  ...
  return (
      <div className="bg-[#0d1117] text-white rounded-2xl shadow-lg p-6">
        {/* HEADER */}
        <div className="mb-5 text-center">
          <h2 className="mb-2 font-[family-name:var(--font-montserrat)] text-blue-600 text-4xl font-black">
            Human Anatomy
          </h2>
          <p className="mx-auto text-blue-900 max-w-2xl text-lg">
            Explore how spaceflight impacts the human body
          </p>
        </div>
